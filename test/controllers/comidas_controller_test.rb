...
class ComidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comida" do
    assert_difference("Comida.count") do
      post comidas_url, params: { comida: { descricao: @comida.descricao, nome: @comida.nome, preco: @comida.preco, tipo: @comida.tipo } }
    end
  ...
  test "should update comida" do
    patch comida_url(@comida), params: { comida: { descricao: @comida.descricao, nome: @comida.nome, preco: @comida.preco, tipo: @comida.tipo } }
